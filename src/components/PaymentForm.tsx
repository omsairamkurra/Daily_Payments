          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
              >
                {gettingLocation ? '...' : '📍'}
              </button>
            </div>
